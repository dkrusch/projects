package com.example.backup.my_game.view;
...
import com.example.backup.my_game.R;
...
public class ReflexView extends View
{
    ...
    public ReflexView(Context context, SharedPreferences sharedPreferences, RelativeLayout parentLayout)
    {
        ...
        livesLinearLayout = relativeLayout.findViewById(R.id.linearLayout);
        highScoreTextView = relativeLayout.findViewById(R.id.txtHighScore);
        currentScoreTextView = relativeLayout.findViewById(R.id.txtScore);
        levelTextView = relativeLayout.findViewById(R.id.txtLevel);
